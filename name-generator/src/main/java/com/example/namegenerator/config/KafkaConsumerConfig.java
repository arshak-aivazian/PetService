...
public class KafkaConsumerConfig {
    ...
    public KafkaListenerContainerFactory<?> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OutputNotificationMessage> factory =
    ...
    @Bean
    public ConsumerFactory<String, OutputNotificationMessage> consumerFactory() {
        JsonDeserializer<OutputNotificationMessage> deserializer = new JsonDeserializer<>(OutputNotificationMessage.class);
